...
this.keys(),this._next.pop();else if(this._next.length===0)return this._next=void 0},object:function(){return this._table},isEqual:function(a){return!(a instanceof List)?!1:f(this._table,a._table)}}}();
